...
unknown_face_locations = face_recognition.face_locations(unknown_image, number_of_times_to_upsample= 2) #the face is too small so need to enlarge the image. It will slow down the process
